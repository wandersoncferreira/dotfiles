;;; patch-hippie-expand.el --- Code extracted from magnars .emacs.d configuration file

;;; Commentary:

;; Two new keybinding C-: and C-. to use hippie-expand.
...
(provide 'patch-hippie-expand)
;;; patch-hippie-expand.el ends here
