;;; doom-nord-right-theme.el --- inspired by Nord -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup doom-nord-right-theme nil
  "Options for the `doom-nord-right' theme."
  :group 'doom-themes)

(defcustom doom-nord-right-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-nord-right-theme
  :type 'boolean)

(defcustom doom-nord-right-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-nord-right-theme
  :type 'boolean)

(defcustom doom-nord-right-comment-bg doom-nord-right-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-nord-right-theme
  :type 'boolean)

(defcustom doom-nord-right-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-nord-right-theme
  :type '(choice integer boolean))

(defcustom doom-nord-right-region-highlight t
...
;;
(def-doom-theme doom-nord-right
  "A light theme inspired by Nord-Right."
  ...
  ((bg         '("#ffffff" "#ffffff" nil))
   ...
   (builtin teal)
   (comments (if doom-nord-right-brighter-comments dark-cyan (doom-darken base5 0.2)))
   (doc-comments (doom-darken (if doom-nord-right-brighter-comments dark-cyan base5) 0.25))
   (constants magenta)
   (functions teal)
   (keywords blue)
   (methods teal)
   ...
   (variables violet)
   (numbers magenta)
   (region (pcase doom-nord-right-region-highlight
   ...
   (-modeline-bright doom-nord-right-brighter-modeline)
   (-modeline-pad
    (when doom-nord-right-padded-modeline
      (if (integerp doom-nord-right-padded-modeline) doom-nord-right-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :background (if doom-nord-right-comment-bg (doom-lighten bg 0.05)))
   ...
   ((region &override)
    :foreground (if (memq doom-nord-right-region-highlight '(frost snowstorm))
                    bg-alt))
...
;;; doom-nord-right-theme.el ends here
