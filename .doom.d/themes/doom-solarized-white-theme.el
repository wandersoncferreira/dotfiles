;;; doom-solarized-white-theme.el --- inspired by Atom One Dark -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-solarized-white-theme nil
  "Options for the `doom-solarized-white' theme."
  :group 'doom-themes)

(defcustom doom-solarized-white-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-solarized-white-theme
  :type 'boolean)

(defcustom doom-solarized-white-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-solarized-white-theme
  :type 'boolean)

(defcustom doom-solarized-white-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-solarized-white
  "A light theme inspired by Solarized light"

  ;; name        default   256       16
  ((bg         '("#F6F7F9" "#F6F7F9" "white"        ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if doom-solarized-white-brighter-comments
   ...
   ;; custom categories
   (-modeline-bright doom-solarized-white-brighter-modeline)
   (-modeline-pad
    (when doom-solarized-white-padded-modeline
      (if (integerp doom-solarized-white-padded-modeline) doom-solarized-white-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :slant 'italic
    :background (if doom-solarized-white-brighter-comments
...
;;; doom-solarized-white-theme.el ends here
